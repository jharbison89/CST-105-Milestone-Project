...
public class NFLDefensivePlayer
	...
	double getTacklesPerGame() {
		if(getGamesPlayed() != 0) {
			return Math.round((double)(tackles + sacks) / (double)getGamesPlayed() * 1000) / 1000.0;
		}
		else {
			return 0;
		}
	...
	double getInterceptionsPerGame() {
		if(getGamesPlayed() != 0) {
			return Math.round((double)interceptions / (double)getGamesPlayed() * 1000) / 1000.0;
		}
		else {
			return 0;
		}
	...
	double getSacksPerGame() {
		if(getGamesPlayed() != 0) {
			return Math.round((double)sacks / (double)getGamesPlayed() * 1000) / 1000.0;
		}
		else {
			return 0;
		}
